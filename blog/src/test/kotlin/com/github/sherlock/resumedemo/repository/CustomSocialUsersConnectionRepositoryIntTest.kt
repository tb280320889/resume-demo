...
class CustomSocialUsersConnectionRepositoryIntTest {
    ...
    private lateinit var connectionFactoryRegistry: ConnectionFactoryRegistry

    private lateinit var connectionFactory: TestFacebookConnectionFactory

    private lateinit var usersConnectionRepository: CustomSocialUsersConnectionRepository

    private lateinit var connectionRepository: ConnectionRepository

    @Autowired
    private lateinit var socialUserConnectionRepository: SocialUserConnectionRepository
    ...
    fun findUserIdWithConnectionMultipleConnectionsToSameProviderUser() {
        ...
        assertEquals("1", localUserIds[0])
        assertEquals("2", localUserIds[1])
    }
    ...
    fun updateConnectionAccessFields() {
        ...
        assertEquals("234567890", facebook.api.getAccessToken())
        facebook.refresh()
        ...
        assertEquals("765432109", facebook2.api.getAccessToken())
    ...
    private fun insertTwitterConnection(): SocialUserConnection {
    ...
    private fun insertFacebookConnection(): SocialUserConnection {
        return createExistingSocialUserConnection(
            "1",
            "facebook",
            "9",
    ...
    private fun insertFacebookConnection2(): SocialUserConnection {
        return createExistingSocialUserConnection(
            "1",
            "facebook",
            "10",
    ...
    private fun insertFacebookConnection3(): SocialUserConnection {
        return createExistingSocialUserConnection(
            "2",
            "facebook",
            "11", 2L,
    ...
    private fun insertFacebookConnectionSameFacebookUser(): SocialUserConnection {
        return createExistingSocialUserConnection(
            "2",
            "facebook",
            "9",
    ...
    private fun createExistingSocialUserConnection(
        userId: String,
        providerId: String,
        ...
        val socialUserConnectionToSabe = SocialUserConnection(
            null,
            userId,
            providerId,
            providerUserId,
    ...
    private class TestFacebookServiceProvider : OAuth2ServiceProvider<TestFacebookApi> {
        ...
        override fun getOAuthOperations(): OAuth2Operations {
            return object : OAuth2Operations {
                ...
                @Deprecated("", ReplaceWith("AccessGrant(\"765432109\", \"read\", \"654321098\", 3600L)", "org.springframework.social.oauth2.AccessGrant"))
